...
export default function FinanceiroPage() {
  ...
  // Modo de período: "mes" | "customizado" | "anual"
  ...
  useEffect(() => {
    getFornecedores()
      ...
      .catch(() => { /* fornecedores ficam como [] — filtro simplesmente não aparece */ });
  }, []);
  ...
  const range = useMemo(() => {
    ...
    return undefined; // anual — sem range de pagamento, mas usa ano para por_mes
          ...
          {lista.map((f) => {
            ...
            return (
              <div key={f.fornecedor_id ?? "sem"} className="px-4 py-3 space-y-1.5">
                ...
                {/* Barra de progresso pago/aberto */}
          ...
          <table className="w-full text-sm">
            ...
            <tbody className="divide-y divide-zinc-100 dark:divide-zinc-800">
              {por_mes.map((m) => {
                ...
                // Deriva o índice do mês a partir do campo "YYYY-MM" para garantir o nome correto
